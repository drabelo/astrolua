...
export const I18N = {
  pt: {
    ...
    davison: {
      title: 'O terceiro nascimento',
      intro: 'O mapa composto é uma média abstrata. O Davison não: ele é um mapa de verdade, levantado para o ponto médio no tempo e no espaço entre dois nascimentos. Ou seja — a relação de vocês tem um instante e um lugar próprios, muito antes de vocês se conhecerem.',
      whenLabel: 'O instante',
      whereLabel: 'O lugar',
      sunLabel: 'Sol do Davison',
      moonLabel: 'Lua do Davison',
      poetic: 'Entre o nascimento de um e o do outro, existe um ponto exato — uma data, um pedaço de chão em Goiás. É esse o aniversário da coisa que vocês formam.',
    },
    lots: {
      title: 'As partes árabes',
      intro: 'Pontos calculados da astrologia helenística: não são planetas, são lugares do mapa obtidos de distâncias entre Sol, Lua e Ascendente. A Parte da Fortuna fala do corpo e da sorte; a de Espírito, do que se escolhe; a de Eros, do desejo e daquilo que se ama sem conseguir explicar.',
      names: {
        fortune: 'Parte da Fortuna',
        spirit: 'Parte do Espírito',
        eros: 'Parte de Eros',
        love: 'Parte do Amor',
        necessity: 'Parte da Necessidade',
        courage: 'Parte da Coragem',
        victory: 'Parte da Vitória',
        marriage: 'Parte do Casamento',
      },
      meanings: {
        fortune: 'corpo, sorte, o que chega sem esforço',
        spirit: 'vontade, carreira, o que se constrói de propósito',
        eros: 'desejo, paixão, o que se ama sem saber explicar',
        love: 'afeto e o que atrai',
        necessity: 'o que não se escolhe, mas se atravessa',
        courage: 'ousadia e enfrentamento',
        victory: 'fé, esperança, o que dá certo',
        marriage: 'a união e seus termos',
      },
    },
    profection: {
      title: 'O ano que corre',
      intro: 'Técnica helenística: a cada aniversário a vida "avança" uma casa do mapa, e o planeta que rege essa casa vira o senhor do ano — o tema que conduz os próximos doze meses.',
      ...
      houseThemes: {
        ...
        5: 'o amor, os filhos, o prazer', 6: 'o trabalho diário e a saúde',
        7: 'as parcerias e o outro', 8: 'o que se compartilha e o que transforma',
        9: 'a viagem, o estudo, a fé', 10: 'a carreira e o que aparece',
        11: 'os amigos e o que se espera', 12: 'o retiro, o invisível, o descanso',
      },
    },
  ...
  en: {
    ...
    davison: {
      title: 'The third birth',
      intro: 'A composite chart is an abstract average. A Davison is not: it is a real chart, cast for the midpoint in time and space between two births. Which means your relationship has a moment and a place of its own, long before you met.',
      whenLabel: 'The moment',
      whereLabel: 'The place',
      sunLabel: 'Davison Sun',
      moonLabel: 'Davison Moon',
      poetic: 'Between one birth and the other there is an exact point — a date, a patch of ground in Goiás. That is the birthday of the thing you two make.',
    },
    lots: {
      title: 'The Arabic Parts',
      intro: 'Calculated points from Hellenistic astrology: not planets, but places in the chart derived from the distances between Sun, Moon, and Ascendant. The Part of Fortune speaks of the body and of luck; the Part of Spirit, of what you choose; the Part of Eros, of desire and of what you love without being able to explain.',
      names: {
        ...
        marriage: 'Part of Marriage',
      },
      meanings: {
        fortune: 'body, luck, what arrives without effort',
        spirit: 'will, career, what you build on purpose',
        eros: 'desire, passion, what you love without knowing why',
        love: 'affection and what draws you',
        necessity: 'what you do not choose, but pass through',
        courage: 'daring and confrontation',
        victory: 'faith, hope, what works out',
        marriage: 'the union and its terms',
      },
    },
    profection: {
      title: 'The year in motion',
      intro: 'A Hellenistic technique: every birthday, life "advances" one house of the chart, and the planet ruling that house becomes the lord of the year — the theme steering the next twelve months.',
      ...
      houseThemes: {
        ...
        5: 'love, children, pleasure', 6: 'daily work and health',
        7: 'partnership and the other person', 8: 'what is shared and what transforms',
        9: 'travel, study, faith', 10: 'career and what shows',
        11: 'friends and what you hope for', 12: 'retreat, the unseen, rest',
      },
    },
